...
export class UseInfoService {
  ...
  search(body?: useInfo.GetRequest) {
    ...
    return this.http.post<base.ResponsesBase<useInfo.GetResponses[]>>(`${this.apiUrl}/Auth/UseInfo/Get`, body);
  }

  add(body: useInfo.CreateRequest) {
    return this.http.post<base.ResponsesBase<useInfo.CreateResponses>>(`${this.apiUrl}/Auth/UseInfo/Create`, body);
  }
  ...
  getDetail(body: useInfo.GetDetailRequest) {
    return this.http.post<base.ResponsesBase<useInfo.GetDetailResponses>>(`${this.apiUrl}/Auth/UseInfo/GetDetail`, body);
  }

  convertState(body: useInfo.ConvertStateRequest) {
    return this.http.post<base.ResponsesBase<useInfo.ConvertStateResponses>>(`${this.apiUrl}/Auth/UseInfo/ConvertState`, body);
  }
}
